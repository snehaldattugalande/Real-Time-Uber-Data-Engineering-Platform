# uber_rides_ingestion

This folder defines all source code for the 'uber_rides_ingestion' pipeline:
...
* Take a look at the sample under "sample_users_uber_rides_ingestion.py" to get familiar with the syntax.
